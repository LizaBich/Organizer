...
1. Возможность добавить событие на любой день, просмотреть его, изменить, при желании удалить.
2. Возможность добавить до 50 заметок. Каждая может быть просмотрена, изменена или удалена.
